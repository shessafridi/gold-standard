...
- The API exposes autogenerated Scalar/Swagger docs at `/api/docs` and the JSON spec at `/api/spec`, making API discovery and contract validation a first-class architectural concern.
